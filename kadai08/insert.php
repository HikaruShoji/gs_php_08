...
$stmt = $pdo->prepare("INSERT INTO b_table(id, name, industry, pref, telNumber, naiyou,
indate )VALUES(NULL, :name, :industry, :pref, :telNumber, :naiyou, sysdate())");
...
$stmt->bindValue(':telNumber', $telNumber, PDO::PARAM_STR);  //Integer（数値の場合 PDO::PARAM_INT)
